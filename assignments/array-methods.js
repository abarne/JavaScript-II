...
// Problem 1
//return an array of all of the runners that have reached donations of 200 or more.
const largeDonations = runners.filter(function(item) {
	return item.donation >= 200;
});
console.log(largeDonations);

// Problem 2
//return an array of all the runners last names
const runnersLastNames = runners.map(function(item) {
